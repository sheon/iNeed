...
@Serializable
data class User(val name: String, val address: String, var availableAtTheMoment: Boolean = true, val profilePic: Int? = null, var subscription: String = "free", var availableDays: UserSchedule = UserSchedule.EVERYDAY, val availableTime: Long = 0) {
